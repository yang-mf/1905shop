...
<form action="{{url('/index/store')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="goods_price" placeholder="请输入商品价格">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="goods_num" placeholder="请输入商品价格">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea name="goods_desc" cols="30" rows="10" placeholder="请输入商品详情"></textarea>
