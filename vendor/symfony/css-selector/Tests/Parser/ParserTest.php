...
class ParserTest extends TestCase
{
    ...
    public function getParserTestData()
    {
        return [
            ...
            ['div>.foo', ['CombinedSelector[Element[div] > Cal[Element[*].foo]]']],
            ['div> .foo', ['CombinedSelector[Element[div] > Cal[Element[*].foo]]']],
            ['div >.foo', ['CombinedSelector[Element[div] > Cal[Element[*].foo]]']],
            ['div > .foo', ['CombinedSelector[Element[div] > Cal[Element[*].foo]]']],
            ["div \n>  \t \t .foo", ['CombinedSelector[Element[div] > Cal[Element[*].foo]]']],
            ['td.foo,.bar', ['Cal[Element[td].foo]', 'Cal[Element[*].bar]']],
            ['td.foo, .bar', ['Cal[Element[td].foo]', 'Cal[Element[*].bar]']],
            ["td.foo\t\r\n\f ,\t\r\n\f .bar", ['Cal[Element[td].foo]', 'Cal[Element[*].bar]']],
            ['td.foo,.bar', ['Cal[Element[td].foo]', 'Cal[Element[*].bar]']],
            ['td.foo, .bar', ['Cal[Element[td].foo]', 'Cal[Element[*].bar]']],
            ["td.foo\t\r\n\f ,\t\r\n\f .bar", ['Cal[Element[td].foo]', 'Cal[Element[*].bar]']],
            ['div, td.foo, div.bar span', ['Element[div]', 'Cal[Element[td].foo]', 'CombinedSelector[Cal[Element[div].bar] <followed> Element[span]]']],
            ...
            ['div div:nth-of-type(10) .aclass', ["CombinedSelector[CombinedSelector[Element[div] <followed> Function[Element[div]:nth-of-type(['10'])]] <followed> Cal[Element[*].aclass]]"]],
            ...
            ['div:not(div.foo)', ['Negation[Element[div]:not(Cal[Element[div].foo])]']],
            ['td ~ th', ['CombinedSelector[Element[td] ~ Element[th]]']],
            ['.foo[data-bar][data-baz=0]', ["Attribute[Attribute[Cal[Element[*].foo][data-bar]][data-baz = '0']]"]],
        ];
    }
    ...
    public function getPseudoElementsTestData()
    {
        return [
            ...
            ['lorem#ipsum ~ a#b.c[href]:empty::selection', 'CombinedSelector[Hash[Element[lorem]#ipsum] ~ Pseudo[Attribute[Cal[Hash[Element[a]#b].c][href]]:empty]]', 'selection'],
