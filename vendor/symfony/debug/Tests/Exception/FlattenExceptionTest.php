...
class FlattenExceptionTest extends TestCase
{
    ...
    public function testAnonymousClass()
    {
        ...
        $flattened = FlattenException::create(new \Exception(sprintf('Cal "%s" blah.', \get_class(new class() extends \RuntimeException {
        }))));

        $this->assertSame('Cal "RuntimeException@anonymous" blah.', $flattened->getMessage());
    }
